# Codebase Audit Report — FishAudioOrchestrator

**Date:** 2026-04-01
**Scope:** All source files in `src/FishAudioOrchestrator.Web/`
...
**File:** `src/FishAudioOrchestrator.Web/Endpoints/AuthEndpoints.cs`, lines 47-75
...
**File:** `src/FishAudioOrchestrator.Web/Hubs/OrchestratorHub.cs`, lines 21-28
...
**File:** `src/FishAudioOrchestrator.Web/Program.cs`, line 183
...
**File:** `src/FishAudioOrchestrator.Web/Middleware/SetupGuardMiddleware.cs`, lines 32-37
...
**File:** `src/FishAudioOrchestrator.Web/Services/TtsJobProcessor.cs`, line 40
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/Dashboard.razor`, lines 284-301
...
**File:** `src/FishAudioOrchestrator.Web/Services/ContainerLogService.cs`, lines 127-146
...
**File:** `src/FishAudioOrchestrator.Web/Services/SetupDownloadService.cs`, line 106
...
**File:** `src/FishAudioOrchestrator.Web/Services/HealthMonitorService.cs`, lines 52-58
...
**File:** `src/FishAudioOrchestrator.Web/Program.cs`, line 116
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/Login.razor`, lines 16-26
...
**File:** `src/FishAudioOrchestrator.Web/Services/TtsClientService.cs`, lines 118-139
...
**File:** `src/FishAudioOrchestrator.Web/StringHelpers.cs`, line 5
...
**File:** `src/FishAudioOrchestrator.Web/Components/App.razor`, line 10
...
**File:** `src/FishAudioOrchestrator.Web/Components/Layout/NavMenu.razor`, line 52
...
**File:** `src/FishAudioOrchestrator.Web/Components/Layout/MainLayout.razor`, lines 50-58
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/Deploy.razor`, lines 112, 230-234
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/GenerationHistory.razor`, lines 176-194
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/Setup.razor`, line 411
...
**File:** `src/FishAudioOrchestrator.Web/Components/Pages/TtsPlayground.razor`, lines 298-304
...
**File:** `src/FishAudioOrchestrator.Web/Program.cs`, line 144
...
**File:** `src/FishAudioOrchestrator.Web/Services/ContainerConfigService.cs`, line 57
**Description:** Container names are set to `$"fish-orch-{profile.Name}"`. Docker container names must match `[a-zA-Z0-9][a-zA-Z0-9_.-]`. If `profile.Name` contains spaces or special characters, container creation will fail with an unhelpful Docker API error.
...
### QUAL-12: `FishProxyConfigProvider` CancellationTokenSource disposal race
**File:** `src/FishAudioOrchestrator.Web/Proxy/FishProxyConfigProvider.cs`, lines 18-31
